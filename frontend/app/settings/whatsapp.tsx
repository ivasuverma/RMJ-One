...
type Form = { enabled: boolean; repair_ready_notice: boolean };
const EMPTY: Form = { enabled: true, repair_ready_notice: true };
...
export default function WhatsAppSettingsScreen() {
  ...
  const load = async () => {
    try {
      ...
      setForm({ enabled: w.enabled !== false, repair_ready_notice: w.repair_ready_notice !== false });
