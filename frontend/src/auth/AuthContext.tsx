...
export type User = {
  ...
  // Owner/admin/accountant only — WhatsApp number for important alerts (see
  // notify_user/notify_roles on the backend). Employees have their own
  // mobile field on their profile instead (routers/employees.py).
  mobile?: string;
